...
import { Nav, NavLinksR, NavbarContainer, Lang, MobileIcon, NavMenu, NavItem, NavLinks, LogoIcon,
          ...
          <NavbarContainer>
            ...
            <NavMenu>
              ...
              <DropDown>
                      ...
                      <DropDownContent>
                          <NavLinksD to ='/consulting'>{t('nav.consulting')}</NavLinksD>
                          <NavLinksD to ='/equipment'>{t('nav.equipment')}</NavLinksD>
                          <NavLinksD to ='/development'>{t('nav.development')}</NavLinksD>
                       </DropDownContent>
              </DropDown>
